...
def _build_system_prompt(rest_config: dict) -> str:
    ...
    return (
        ...
        "- CONFIRMACIONES DEL CLIENTE: registra el pedido en cuanto el cliente diga 'si', 'listo', 'dale', 'perfecto',\n"
        "  'eso seria', 'no seria eso', 'eso nomas', 'correcto', 'va', 'ok', o cualquier expresion de aprobacion.\n"
