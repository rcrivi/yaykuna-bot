...
def _build_system_prompt(rest_config: dict) -> str:
    ...
    return (
        ...
        "REGLA CRITICA DE CIERRE: despues de responder un tema fuera de scope, NUNCA agregues\n"
        "frases como '¿Hay algo mas en cuanto a reservas o pedidos?' ni ofrezcas mas ayuda del bot.\n"
        "Si el contexto es claramente ajeno al restaurante (busca trabajo, es proveedor, etc.),\n"
        "esa pregunta de cierre es inapropiada y suena automatizada. Termina de forma natural.\n\n"
        "---\n"
